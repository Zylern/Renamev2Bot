class EnTrans:
    ...
    START_MSG = "**Hey there send me a file to process.**"
    ...
    RENAME_NOFLTR_NONAME = "**Enter the rename file name in format :**\n `/rename my new filename.extension` or `Use /filters to set some rename filters.`"
...
__Replace Filter: This filter will replace a
given word with the one you sepcified.__

__Addition Filter: This filter will add given word
at end or beginning.__

__Remove Filter: This filer will remove given word
from the file name.__
...
/mode - **Change between 3 modes:**
    ...
    __Upload general media. [In streamable video/audio. etc.]__
